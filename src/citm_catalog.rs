    ...
    fn decode<__D: ::rustc_serialize::Decoder>
        ...
        __arg_0.read_struct("CitmCatalog", 11usize, |_d| -> _ {
            ::std::result::Result::Ok(CitmCatalog {
                area_names:
                    match _d.read_struct_field("areaNames",
                                                0usize,
                ...
                audience_sub_category_names:
                    match _d.read_struct_field("audienceSubCategoryNames",
                                                1usize,
                                                ::rustc_serialize::Decodable::decode) {
                    ::std::result::Result::Ok(__try_var) => __try_var,
                    ::std::result::Result::Err(__try_var) => {
                ...
                block_names:
                    match _d.read_struct_field("blockNames",
                                                2usize,
                                                ::rustc_serialize::Decodable::decode) {
                    ::std::result::Result::Ok(__try_var) => __try_var,
                    ::std::result::Result::Err(__try_var) => {
                ...
                events: match _d.read_struct_field("events",
                                                    3usize,
                                                    ::rustc_serialize::Decodable::decode) {
                    ::std::result::Result::Ok(__try_var) => __try_var,
                    ::std::result::Result::Err(__try_var) => {
                ...
                performances:
                    match _d.read_struct_field("performances",
                                                4usize,
                                                ::rustc_serialize::Decodable::decode) {
                    ::std::result::Result::Ok(__try_var) => __try_var,
                    ::std::result::Result::Err(__try_var) => {
                ...
                seat_category_names:
                    match _d.read_struct_field("seatCategoryNames",
                                                5usize,
                                                ::rustc_serialize::Decodable::decode) {
                    ::std::result::Result::Ok(__try_var) => __try_var,
                    ::std::result::Result::Err(__try_var) => {
                ...
                sub_topic_names:
                    match _d.read_struct_field("subTopicNames",
                                                6usize,
                                                ::rustc_serialize::Decodable::decode) {
                    ::std::result::Result::Ok(__try_var) => __try_var,
                    ::std::result::Result::Err(__try_var) => {
                ...
                subject_names:
                    match _d.read_struct_field("subjectNames",
                                                7usize,
                                                ::rustc_serialize::Decodable::decode) {
                    ::std::result::Result::Ok(__try_var) => __try_var,
                    ::std::result::Result::Err(__try_var) => {
                ...
                topic_names:
                    match _d.read_struct_field("topicNames",
                                                8usize,
                                                ::rustc_serialize::Decodable::decode) {
                    ::std::result::Result::Ok(__try_var) => __try_var,
                    ::std::result::Result::Err(__try_var) => {
                ...
                topic_sub_topics:
                    match _d.read_struct_field("topicSubTopics",
                                                9usize,
                                                ::rustc_serialize::Decodable::decode) {
                    ::std::result::Result::Ok(__try_var) => __try_var,
                    ::std::result::Result::Err(__try_var) => {
                ...
                venue_names:
                    match _d.read_struct_field("venueNames",
                                                10usize,
                                                ::rustc_serialize::Decodable::decode) {
                    ::std::result::Result::Ok(__try_var) => __try_var,
                    ::std::result::Result::Err(__try_var) => {
    ...
    fn encode<__S: ::rustc_serialize::Encoder>(&self,
        ...
        match *self {
            ...
            __arg_0.emit_struct("CitmCatalog", 11usize, |_e| -> _ {
                                match _e.emit_struct_field("areaNames",
                                                            0usize,
                                                            |_e| -> _ {
                                                            ::rustc_serialize::Encodable::encode(&(*__self_0_0),
                                                                                                _e)
                                                        }) {
                                ...
                                match _e.emit_struct_field("audienceSubCategoryNames",
                                                            1usize,
                                                            |_e| -> _ {
                                                            ::rustc_serialize::Encodable::encode(&(*__self_0_1),
                                                                                                _e)
                                                        }) {
                                    ::std::result::Result::Ok(__try_var)
                                    => __try_var,
                                ...
                                match _e.emit_struct_field("blockNames",
                                                            2usize,
                                                            |_e| -> _ {
                                                            ::rustc_serialize::Encodable::encode(&(*__self_0_2),
                                                                                                _e)
                                                        }) {
                                    ::std::result::Result::Ok(__try_var)
                                    => __try_var,
                                ...
                                match _e.emit_struct_field("events",
                                                            3usize,
                                                            |_e| -> _ {
                                                            ::rustc_serialize::Encodable::encode(&(*__self_0_3),
                                                                                                _e)
                                                        }) {
                                    ::std::result::Result::Ok(__try_var)
                                    => __try_var,
                                ...
                                match _e.emit_struct_field("performances",
                                                            4usize,
                                                            |_e| -> _ {
                                                            ::rustc_serialize::Encodable::encode(&(*__self_0_4),
                                                                                                _e)
                                                        }) {
                                    ::std::result::Result::Ok(__try_var)
                                    => __try_var,
                                ...
                                match _e.emit_struct_field("seatCategoryNames",
                                                            5usize,
                                                            |_e| -> _ {
                                                            ::rustc_serialize::Encodable::encode(&(*__self_0_5),
                                                                                                _e)
                                                        }) {
                                    ::std::result::Result::Ok(__try_var)
                                    => __try_var,
                                ...
                                match _e.emit_struct_field("subTopicNames",
                                                            6usize,
                                                            |_e| -> _ {
                                                            ::rustc_serialize::Encodable::encode(&(*__self_0_6),
                                                                                                _e)
                                                        }) {
                                    ::std::result::Result::Ok(__try_var)
                                    => __try_var,
                                ...
                                match _e.emit_struct_field("subjectNames",
                                                            7usize,
                                                            |_e| -> _ {
                                                            ::rustc_serialize::Encodable::encode(&(*__self_0_7),
                                                                                                _e)
                                                        }) {
                                    ::std::result::Result::Ok(__try_var)
                                    => __try_var,
                                ...
                                match _e.emit_struct_field("topicNames",
                                                            8usize,
                                                            |_e| -> _ {
                                                            ::rustc_serialize::Encodable::encode(&(*__self_0_8),
                                                                                                _e)
                                                        }) {
                                    ::std::result::Result::Ok(__try_var)
                                    => __try_var,
                                ...
                                match _e.emit_struct_field("topicSubTopics",
                                                            9usize,
                                                            |_e| -> _ {
                                                            ::rustc_serialize::Encodable::encode(&(*__self_0_9),
                                                                                                _e)
                                                        }) {
                                    ::std::result::Result::Ok(__try_var)
                                    => __try_var,
                                ...
                                return _e.emit_struct_field("venueNames",
                                                            10usize,
                                                            |_e| -> _ {
                                                            ::rustc_serialize::Encodable::encode(&(*__self_0_10),
                                                                                                    _e)
                                                        }); }),
        }
    }
    ...
    fn decode<__D: ::rustc_serialize::Decoder>(__arg_0: &mut __D)
        ...
        __arg_0.read_struct("Event", 8usize, |_d| -> _ {
            ::std::result::Result::Ok(Event {
                ...
                logo: match _d.read_struct_field("logo",
                                                    2usize,
                                                    ::rustc_serialize::Decodable::decode) {
                    ::std::result::Result::Ok(__try_var) => __try_var,
                    ::std::result::Result::Err(__try_var) => {
                ...
                name: match _d.read_struct_field("name",
                                                    3usize,
                                                    ::rustc_serialize::Decodable::decode) {
                    ::std::result::Result::Ok(__try_var) => __try_var,
                    ::std::result::Result::Err(__try_var) => {
                ...
                sub_topic_ids:
                    match _d.read_struct_field("subTopicIds",
                                                4usize,
                                                ::rustc_serialize::Decodable::decode) {
                    ::std::result::Result::Ok(__try_var) => __try_var,
                    ::std::result::Result::Err(__try_var) => {
                ...
                subject_code:
                    match _d.read_struct_field("subjectCode",
                                                5usize,
                                                ::rustc_serialize::Decodable::decode) {
                    ::std::result::Result::Ok(__try_var) => __try_var,
                    ::std::result::Result::Err(__try_var) => {
                ...
                subtitle: match _d.read_struct_field("subtitle",
                                                        6usize,
                                                        ::rustc_serialize::Decodable::decode) {
                    ::std::result::Result::Ok(__try_var) => __try_var,
                    ::std::result::Result::Err(__try_var) => {
                ...
                topic_ids: match _d.read_struct_field("topicIds",
                                                        7usize,
                                                        ::rustc_serialize::Decodable::decode) {
                    ::std::result::Result::Ok(__try_var) => __try_var,
                    ::std::result::Result::Err(__try_var) => {
...
impl ::rustc_serialize::Encodable for Event {
    fn encode<__S: ::rustc_serialize::Encoder>(&self,
                                                ...
                                                -> ::std::result::Result<(), __S::Error> {
        match *self {
            Event { description: ref __self_0_0,
                    id: ref __self_0_1,
                    logo: ref __self_0_2,
                    name: ref __self_0_3,
    ...
    fn decode<__D: ::rustc_serialize::Decoder>
        ...
        __arg_0.read_struct("Performance", 9usize, |_d| -> _ {
            ::std::result::Result::Ok(Performance {
                event_id: match _d.read_struct_field("eventId",
                                                        0usize,
                                                        ::rustc_serialize::Decodable::decode) {
                    ::std::result::Result::Ok(__try_var) => __try_var,
                    ::std::result::Result::Err(__try_var) => {
                ...
                prices: match _d.read_struct_field("prices",
                                                    4usize,
                                                    ::rustc_serialize::Decodable::decode) {
                    ::std::result::Result::Ok(__try_var) => __try_var,
                    ::std::result::Result::Err(__try_var) => {
                ...
                seat_categories:
                    match _d.read_struct_field("seatCategories",
                                                5usize,
                                                ::rustc_serialize::Decodable::decode) {
                    ::std::result::Result::Ok(__try_var) => __try_var,
                    ::std::result::Result::Err(__try_var) => {
                ...
                seat_map_image:
                    match _d.read_struct_field("seatMapImage",
                                                6usize,
                                                ::rustc_serialize::Decodable::decode) {
                    ::std::result::Result::Ok(__try_var) => __try_var,
                    ::std::result::Result::Err(__try_var) => {
                ...
                start: match _d.read_struct_field("start",
                                                    7usize,
                                                    ::rustc_serialize::Decodable::decode) {
                    ::std::result::Result::Ok(__try_var) => __try_var,
                    ::std::result::Result::Err(__try_var) => {
                ...
                venue_code:
                    match _d.read_struct_field("venueCode",
                                                8usize,
                                                ::rustc_serialize::Decodable::decode) {
                    ::std::result::Result::Ok(__try_var) => __try_var,
                    ::std::result::Result::Err(__try_var) => {
...
impl ::rustc_serialize::Encodable for Performance {
    fn encode<__S: ::rustc_serialize::Encoder>(&self,
                                                ...
                                                -> ::std::result::Result<(), __S::Error> {
        match *self {
            Performance { event_id: ref __self_0_0,
                            id: ref __self_0_1,
                            logo: ref __self_0_2,
                            name: ref __self_0_3,
    ...
    fn decode<__D: ::rustc_serialize::Decoder>(__arg_0: &mut __D)
        ...
        __arg_0.read_struct("Price", 3usize, |_d| -> _ {
            ::std::result::Result::Ok(Price {
                amount: match _d.read_struct_field("amount",
                                                    0usize,
                                                    ::rustc_serialize::Decodable::decode) {
                    ::std::result::Result::Ok(__try_var) => __try_var,
                    ::std::result::Result::Err(__try_var) => {
                ...
                audience_sub_category_id:
                    match _d.read_struct_field("audienceSubCategoryId",
                                                1usize,
                                                ::rustc_serialize::Decodable::decode) {
                    ::std::result::Result::Ok(__try_var) => __try_var,
                    ::std::result::Result::Err(__try_var) => {
                ...
                seat_category_id:
                    match _d.read_struct_field("seatCategoryId",
                                                2usize,
                                                ::rustc_serialize::Decodable::decode) {
                    ::std::result::Result::Ok(__try_var) => __try_var,
                    ::std::result::Result::Err(__try_var) => {
    ...
    fn encode<__S: ::rustc_serialize::Encoder>(&self,
        ...
        match *self {
            ...
            __arg_0.emit_struct("Price", 3usize, |_e| -> _ {
                                match _e.emit_struct_field("amount",
                                                            0usize,
                                                            |_e| -> _ {
                                                            ::rustc_serialize::Encodable::encode(&(*__self_0_0),
                                                                                                _e)
                                ...
                                match _e.emit_struct_field("audienceSubCategoryId",
                                                            1usize,
                                                            |_e| -> _ {
                                                            ::rustc_serialize::Encodable::encode(&(*__self_0_1),
                                                                                                _e)
                                ...
                                return _e.emit_struct_field("seatCategoryId",
                                                            2usize,
                                                            |_e| -> _ {
                                                            ::rustc_serialize::Encodable::encode(&(*__self_0_2),
                                                                                                    _e)
    ...
    fn decode<__D: ::rustc_serialize::Decoder>
        ...
        __arg_0.read_struct("SeatCategory", 2usize, |_d| -> _ {
            ::std::result::Result::Ok(SeatCategory {
                areas: match _d.read_struct_field("areas",
                                                    0usize,
                                                    ::rustc_serialize::Decodable::decode) {
                    ::std::result::Result::Ok(__try_var) => __try_var,
                    ::std::result::Result::Err(__try_var) => {
...
impl ::rustc_serialize::Encodable for SeatCategory {
    fn encode<__S: ::rustc_serialize::Encoder>(&self,
                                                ...
                                                -> ::std::result::Result<(), __S::Error> {
        match *self {
            SeatCategory { areas: ref __self_0_0, seat_category_id: ref __self_0_1 } => {
    ...
    fn decode<__D: ::rustc_serialize::Decoder>(__arg_0: &mut __D)
        ...
        __arg_0.read_struct("Area", 2usize, |_d| -> _ {
            ::std::result::Result::Ok(Area {
                area_id: match _d.read_struct_field("areaId",
                                                    0usize,
                                                    ::rustc_serialize::Decodable::decode) {
                    ::std::result::Result::Ok(__try_var) => __try_var,
                    ::std::result::Result::Err(__try_var) => {
                ...
                block_ids: match _d.read_struct_field("blockIds",
                                                        1usize,
                                                        ::rustc_serialize::Decodable::decode) {
                    ::std::result::Result::Ok(__try_var) => __try_var,
                    ::std::result::Result::Err(__try_var) => {
...
impl ::rustc_serialize::Encodable for Area {
    fn encode<__S: ::rustc_serialize::Encoder>(&self,
                                                ...
                                                -> ::std::result::Result<(), __S::Error> {
        match *self {
            Area { area_id: ref __self_0_0, block_ids: ref __self_0_1 } => {
