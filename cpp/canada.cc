...
Canada::Canada()
    : state_(kFeatureCollection), feature_collection_type_(), feature_type_(),
      geometry_type_(), features_(), property_(), properties_(), geometry_(),
      coordinates_(), latitude_() {}
...
bool Canada::Int(int i) { return Double(i); }

bool Canada::Uint(unsigned u) { return Double(u); }
